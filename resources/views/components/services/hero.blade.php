<section class="relative bg-linear-to-r from-blue-700 via-blue-600 to-teal-600 text-white py-20 overflow-hidden">
  <div class="max-w-5xl mx-auto px-6 text-center pb-8">
    ...
    <p class="text-lg text-blue-100 max-w-2xl mx-auto">
      Professional, reliable cleaning solutions tailored to your home or business.
    </p>

  </div>

  <!-- Decorative geometric circles / glows -->
  ...
  <!-- Optional subtle diagonal overlay for depth -->
